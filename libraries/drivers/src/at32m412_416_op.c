...
/**
  ...
  *         this parameter can be one of the following values:  
  *         - OP_NON_INVERTING_INPUT_INP0
  *         - OP_NON_INVERTING_INPUT_INP1
  *         - OP_NON_INVERTING_INPUT_INP2
  *         - OP_NON_INVERTING_INPUT_INP3
  * @retval none
  */
void op_set_input_non_inverting(op_type *op_x, op_non_inverting_input_type non_inverting_input)
{
  ...
  op_x->ctrl_bit.inpsel = non_inverting_input;
}
...
/**
  ...
  *         this parameter can be one of the following values:  
  *         - OP_INVERTING_INPUT_INM0
  *         - OP_INVERTING_INPUT_INM1
...
void op_set_input_inverting(op_type *op_x, op_inverting_input_type inverting_input)
{
  ...
  op_x->ctrl_bit.inmsel = inverting_input;
}
...
void op_input_non_inverting_switch(op_type *op_x, op_non_inverting_input_type non_inverting_input)
{
  ...
  op_x->tc_bit.inpssel = non_inverting_input;
}
