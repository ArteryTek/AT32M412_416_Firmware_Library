...
typedef enum
{
  ...
  OP_FOLLOWER_MODE                       = ((uint32_t)0x00000060), /*!< op functional mode, in follower mode and inmsel[1:0]=0x3 */
  OP_PGA_MODE                            = ((uint32_t)0x00000040), /*!< op functional mode, in pga mode and inmsel[1:0]=0x2 */
  OP_PGA_INM0_MODE                       = ((uint32_t)0x00040040), /*!< op functional mode, in pga mode and the inverting input is connected to inm0 for filtering */
  OP_PGA_INM0_BIAS_MODE                  = ((uint32_t)0x00020040), /*!< op functional mode, in pga mode and the inverting input is connected to inm0
                                                                        - input signal on inm0, bias on inpx: negative gain
                                                                        - bias on inm0, input signal on inpx: positive gain */
  OP_PGA_INM0_INM1_BIAS_MODE             = ((uint32_t)0x00060040), /*!< op functional mode, in pga mode and the inverting input is connected to inm0
                                                                        - input signal on inm0, bias on inpx: negative gain
                                                                        - bias on inm0, input signal on inpx: positive gain 
                                                                        and inm1 is connected to for filtering */
...
typedef enum
{
  OP_NON_INVERTING_INPUT_INP0            = 0x00, /*!< vinp0 pin connected to op inp input */
  OP_NON_INVERTING_INPUT_INP1            = 0x01, /*!< vinp1 pin connected to op inp input */
  OP_NON_INVERTING_INPUT_INP2            = 0x02, /*!< vinp2 pin connected to op inp input */
  OP_NON_INVERTING_INPUT_INP3            = 0x03, /*!< vinp3 pin connected to op inp input */
...
typedef enum
{
  OP_INVERTING_INPUT_INM0                = 0x00, /*!< vinm0 pin connected to op inm input */
  OP_INVERTING_INPUT_INM1                = 0x01, /*!< vinm1 pin connected to op inm input */
...
typedef struct
{
  ...
  union
  {
    ...
    struct
    {
      ...
      __IO uint32_t inpsel               : 2; /* [3:2] */
      __IO uint32_t usertrim             : 1; /* [4] */
      __IO uint32_t inmsel               : 2; /* [6:5] */
  ...
  union
  {
    ...
    struct
    {
      __IO uint32_t inmssel              : 1; /* [0] */
      __IO uint32_t inpssel              : 2; /* [2:1] */
