...
/** @addtogroup 412_DMAMUX_synchronization_exint DMAMUX_synchronization_exint
  * @{
  */
...
int main(void)
{
  ...
  /* exint line0 interrupt nvic init */
  ...
  dmamux_sync_config(DMA1MUX_CHANNEL4, &dmamux_sync_init_struct);
  ...
  dmamux_init(DMA1MUX_CHANNEL4, DMAMUX_DMAREQ_ID_TMR1_OVERFLOW);
