...
/** @addtogroup 412_CRM_pll_parameter_calculate CRM_pll_parameter_calculate
  * @{
  */
...
/**
  * @brief  system clock config 180mhz
  ...
  * @retval none
  */
void system_clock_config_180mhz(void)
{
  ...
  calculate_status = crm_pll_parameter_calculate(CRM_PLL_SOURCE_HEXT, 180000000, &pll_ms, &pll_ns, &pll_fr);
