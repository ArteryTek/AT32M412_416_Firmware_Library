...
/** @addtogroup 412_ADC_combine_ordinary_smlt_tmr1ch1_dma3 ADC_combine_ordinary_smlt_tmr1ch1_dma3
  * @{
  */

#define DMA_BUFFER_SIZE                  9

__IO uint16_t adccom_ordinary_valuetab[3][3];
...
int main(void)
{
  ...
  dma_config();
  adc_config();
  printf("combine_ordinary_smlt_tmr1ch1_dma3 \r\n");
