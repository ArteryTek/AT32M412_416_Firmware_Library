...
/** @addtogroup 412_ADC_ordinary_preempt_oversampling ADC_ordinary_preempt_oversampling
  * @{
  */

#define DMA_BUFFER_SIZE                  15
...
static void gpio_config(void)
{
  ...
  gpio_initstructure.gpio_pins = GPIO_PINS_2 | GPIO_PINS_4 | GPIO_PINS_6;
  gpio_init(GPIOA, &gpio_initstructure);

  gpio_initstructure.gpio_mode = GPIO_MODE_ANALOG;
  gpio_initstructure.gpio_pins = GPIO_PINS_12 | GPIO_PINS_14 | GPIO_PINS_15;
...
static void adc_config(void)
{
  ...
  adc_ordinary_channel_set(ADC1, ADC_CHANNEL_2, 1, ADC_SAMPLETIME_7_5);
  adc_ordinary_channel_set(ADC1, ADC_CHANNEL_4, 2, ADC_SAMPLETIME_7_5);
  ...
  adc_preempt_channel_set(ADC1, ADC_CHANNEL_12, 1, ADC_SAMPLETIME_7_5);
  adc_preempt_channel_set(ADC1, ADC_CHANNEL_14, 2, ADC_SAMPLETIME_7_5);
  adc_preempt_channel_set(ADC1, ADC_CHANNEL_15, 3, ADC_SAMPLETIME_7_5);
