...
/** @addtogroup 412_ADC_exint_trigger_partitioned ADC_exint_trigger_partitioned
  * @{
  */
...
static void adc_config(void)
{
  ...
  adc_ordinary_channel_set(ADC1, ADC_CHANNEL_4, 2, ADC_SAMPLETIME_28_5);
  adc_ordinary_channel_set(ADC1, ADC_CHANNEL_6, 3, ADC_SAMPLETIME_28_5);
  ...
  adc_preempt_channel_set(ADC1, ADC_CHANNEL_12, 1, ADC_SAMPLETIME_28_5);
  adc_preempt_channel_set(ADC1, ADC_CHANNEL_14, 2, ADC_SAMPLETIME_28_5);
  adc_preempt_channel_set(ADC1, ADC_CHANNEL_15, 3, ADC_SAMPLETIME_28_5);
