...
/** @addtogroup 412_TMR_complementary_signals TMR_complementary_signals
  * @{
  */
...
int main(void)
{
  ...
  1/ generate 3 complementary pwm signals with 3 different duty cycles:
    ...
    the channel 4 duty cycle is set to 5% so channel 4n is set to 95%.
  ...
  4/ use the locking parameters level3.
  ----------------------------------------------------------------------- */
