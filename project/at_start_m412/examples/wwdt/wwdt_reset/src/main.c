...
/** @addtogroup 412_WWDT_wwdt_reset WWDT_wwdt_reset
  * @{
  */
...
int main(void)
{
  ...
  /* enable wwdt
   ...
   timeout = 64 * (32768 / 180000000 ) = 0.0116s
   window  = 16 * (32768 / 180000000 ) = 0.0029s
  ...
  */
  ...
  while(1)
  {
    ...
    /* the reload time must within the window (10ms > 4.4ms) */
    delay_ms(10);
