...
#ifndef __AT32M412_416_BOARD_H
#define __AT32M412_416_BOARD_H
...
/**
  ...
  *   1. at-start-m412 v1.x board
  *   2. at-start-m416 v1.x board
  * if define AT_START_M412_V1, the header file support at-start-m412 v1.x board
  * if define AT_START_M416_V1, the header file support at-start-m416 v1.x board
  */

#if !defined (AT_START_M412_V1) && !defined (AT_START_M416_V1)
#error "please select first the board at-start device used in your application (in at32m412_416_board.h file)"
#endif
