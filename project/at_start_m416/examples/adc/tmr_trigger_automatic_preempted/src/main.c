...
/** @addtogroup 416_ADC_tmr_trigger_automatic_preempted ADC_tmr_trigger_automatic_preempted
  * @{
  */
...
static void adc_config(void)
{
  ...
  adc_preempt_channel_set(ADC1, ADC_CHANNEL_12, 1, ADC_SAMPLETIME_41_5);
  adc_preempt_channel_set(ADC1, ADC_CHANNEL_14, 2, ADC_SAMPLETIME_41_5);
  adc_preempt_channel_set(ADC1, ADC_CHANNEL_15, 3, ADC_SAMPLETIME_41_5);
