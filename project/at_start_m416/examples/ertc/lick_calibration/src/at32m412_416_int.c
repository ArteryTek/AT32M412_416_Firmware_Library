...
/** @addtogroup 416_ERTC_lick_calibration
  * @{
  */
...
/**
  * @brief  this function handles TMR11 global interrupt request.
  * @param  none
  * @retval none
  */
void TMR1_TRG_HALL_TMR11_IRQHandler(void)
{
  if (tmr_interrupt_flag_get(TMR11, TMR_C1_FLAG) != RESET)
  {
    /* get the input capture value */
    tmp_c4[capture_number++] = tmr_channel_value_get(TMR11, TMR_SELECT_CHANNEL_1);

    /* clear c4 interrupt pending bit */
    tmr_flag_clear(TMR11, TMR_C1_FLAG);
