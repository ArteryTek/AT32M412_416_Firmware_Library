...
/** @addtogroup 416_CAN_filter CAN_filter
  * @{
  */
...
static void can_filter_config(void)
{
  ...
  can_filter_struct.mask_para.fd_error_state = TRUE;  /* mask error_state, not filter. */
  can_filter_struct.mask_para.fd_format = TRUE;       /* mask format_type, not filter. */
  can_filter_struct.mask_para.fd_rate_switch = TRUE;  /* mask switch_type, not filter. */
  can_filter_struct.mask_para.recv_frame = TRUE;      /* mask recv_type, not filter. */    
