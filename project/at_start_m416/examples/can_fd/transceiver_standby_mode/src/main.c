...
/** @addtogroup 416_CAN_transceiver_standby_mode CAN_transceiver_standby_mode
  * @{
  */
...
static void can_echo_data(const can_rxbuf_type* can_rxbuf_struct)
{
  ...
  can_txbuf_struct.fd_format = can_rxbuf_struct->fd_format;
  can_txbuf_struct.fd_rate_switch = can_rxbuf_struct->fd_rate_switch;
  can_txbuf_struct.data_length = can_rxbuf_struct->data_length;
  for(i=0; i<dlc_to_bytes[can_rxbuf_struct->data_length]; i++)
  {
