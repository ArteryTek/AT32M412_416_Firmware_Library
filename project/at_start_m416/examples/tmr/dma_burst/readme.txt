/**
  ...
  */
  ...
  on the dma update request, 999 will be transferred into pr, 0
  will be transferred into rpr, 400 will be transferred into c1dt.
  ...
  tmr1 frequency = tmr1 counter clock/(pr + 1) = apb2_freq / 999 = 180khz
  tmr1 channel1 duty cycle = (tim1_c1dt/ tmr1_pr)* 100 = 40%
